        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h2 class="box-title">{{Lang::get('tickets::lang.SLA_plan')}}</h2><a href="{{route('sla.create')}}"
                                                                                         class="btn btn-primary pull-right">{{Lang::get('tickets::lang.create_SLA')}}</a>
                </div>
                            ...
                            @foreach($slas as $sla)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('sla.edit',$sla->id)}}" class="btn btn-info btn-xs btn-flat"><i
