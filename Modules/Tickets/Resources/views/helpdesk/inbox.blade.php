...
<?php
    ...
    if(Auth::guard('staff')->user()->role == 'agent') {
        ...
        $tickets = Modules\Core\Models\Ticket\Tickets::where('status', '=', 1)->where('dept_id','=',$dept->id)->orderBy('id', 'DESC')->paginate(20);
    } else {
        $tickets = Modules\Core\Models\Ticket\Tickets::where('status', '=', 1)->orderBy('id', 'DESC')->paginate(20);
    }   
?>
<!-- Main content -->
