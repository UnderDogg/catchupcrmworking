...
<?php 
    ...
    if(Auth::guard('staff')->user()->role == 'agent') {
        ...
        $tickets = Modules\Core\Models\Ticket\Tickets::where('status', '=', 1)->where('isanswered', '=', 0)->orderBy('id', 'DESC')->paginate(20);
    } 
?>
<!-- Main content -->
<div class="box box-primary">
     <div class="box-header with-border">
        <h3 class="box-title">{!! Lang::get('tickets::lang.open') !!} </h3> <small id="title_refresh">{!! $tickets->total() !!} {!! Lang::get('tickets::lang.tickets') !!}</small>
